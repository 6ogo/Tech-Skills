# Skill 09: Azure Storage & ADLS

## 🎯 Overview
Blob operations, lifecycle policies, access tiers
...
Core implementation for azure storage & adls.

### 2. Configuration Manager
Manage configuration and settings for azure storage & adls.
...
```python
# Example implementation for Azure Storage & ADLS
from azure import 09_storage_adls

# Initialize
service = 09StorageAdlsService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-09-storage-adls.yml
name: Deploy Azure Storage & ADLS

on:
  push:
    paths:
      - 'azure/skills/09-storage-adls/**'
    branches:
      - main
