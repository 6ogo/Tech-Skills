# Skill 02: Resource Tagging Strategy

## 🎯 Overview
Tag policies, enforcement, Azure Policy
...
Core implementation for resource tagging strategy.

### 2. Configuration Manager
Manage configuration and settings for resource tagging strategy.
...
```python
# Example implementation for Resource Tagging Strategy
from finops import 02_resource_tagging

# Initialize
service = 02ResourceTaggingService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-02-resource-tagging.yml
name: Deploy Resource Tagging Strategy

on:
  push:
    paths:
      - 'finops/skills/02-resource-tagging/**'
    branches:
      - main
