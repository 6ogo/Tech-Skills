# Skill 08: Chargeback & Showback

## 🎯 Overview
Cost allocation, team reporting
...
Core implementation for chargeback & showback.

### 2. Configuration Manager
Manage configuration and settings for chargeback & showback.
...
```python
# Example implementation for Chargeback & Showback
from finops import 08_chargeback

# Initialize
service = 08ChargebackService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-08-chargeback.yml
name: Deploy Chargeback & Showback

on:
  push:
    paths:
      - 'finops/skills/08-chargeback/**'
    branches:
      - main
