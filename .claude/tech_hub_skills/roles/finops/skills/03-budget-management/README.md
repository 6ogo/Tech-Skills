...
Manage configuration and settings for budget management & alerts.
...
from finops import 03_budget_management

# Initialize
service = 03BudgetManagementService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-03-budget-management.yml
name: Deploy Budget Management & Alerts

on:
  push:
    paths:
      - 'finops/skills/03-budget-management/**'
    branches:
      - main
