# Skill 04: Identity & Access Management (IAM)

## 🎯 Overview
Azure AD auditor, OAuth2/OIDC templates, service principal lifecycle
...
Core implementation for identity & access management (iam).

### 2. Configuration Manager
Manage configuration and settings for identity & access management (iam).
...
```python
# Example implementation for Identity & Access Management (IAM)
from security_architect import 04_iam

# Initialize
service = 04IamService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-04-iam.yml
name: Deploy Identity & Access Management (IAM)

on:
  push:
    paths:
      - 'security-architect/skills/04-iam/**'
    branches:
      - main
