# Skill 05: Application Security (SAST/DAST)

## 🎯 Overview
Bandit/Semgrep integration, dependency scanning, API security testing
...
Core implementation for application security (sast/dast).

### 2. Configuration Manager
Manage configuration and settings for application security (sast/dast).
...
```python
# Example implementation for Application Security (SAST/DAST)
from security_architect import 05_application_security

# Initialize
service = 05ApplicationSecurityService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-05-application-security.yml
name: Deploy Application Security (SAST/DAST)

on:
  push:
    paths:
      - 'security-architect/skills/05-application-security/**'
    branches:
      - main
...
**Skill ID**: `05-application-security`  
**Complexity**: Medium  
**Dependencies**: do-01  
**Business Value**: High  
