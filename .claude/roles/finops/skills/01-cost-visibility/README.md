# Skill 01: Cost Visibility & Reporting

## 🎯 Overview
Azure Cost Management, dashboards, anomaly detection
...
Core implementation for cost visibility & reporting.

### 2. Configuration Manager
Manage configuration and settings for cost visibility & reporting.
...
```python
# Example implementation for Cost Visibility & Reporting
from finops import 01_cost_visibility

# Initialize
service = 01CostVisibilityService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-01-cost-visibility.yml
name: Deploy Cost Visibility & Reporting

on:
  push:
    paths:
      - 'finops/skills/01-cost-visibility/**'
    branches:
      - main
