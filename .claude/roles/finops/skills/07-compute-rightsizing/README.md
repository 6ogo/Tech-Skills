# Skill 07: Compute Right-sizing

## 🎯 Overview
Azure Advisor, metrics analysis
...
Core implementation for compute right-sizing.

### 2. Configuration Manager
Manage configuration and settings for compute right-sizing.
...
```python
# Example implementation for Compute Right-sizing
from finops import 07_compute_rightsizing

# Initialize
service = 07ComputeRightsizingService()
...
### CI/CD Example
```yaml
# .github/workflows/deploy-07-compute-rightsizing.yml
name: Deploy Compute Right-sizing

on:
  push:
    paths:
      - 'finops/skills/07-compute-rightsizing/**'
    branches:
      - main
...
**Skill ID**: `07-compute-rightsizing`  
**Complexity**: Medium  
**Dependencies**: fo-01  
**Business Value**: High  
